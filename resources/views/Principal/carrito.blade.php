				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						...
						@if ($Paquete)
							...
							<form action=" {{ route('EliminarDelPaquete') }} " method="POST">
								@csrf 
								<input type="text" name="id_servicio" class="d-none" value="{{ $servicio['id_servicio'] }}">
								<div class="row container">
									...
									<div class="row col-md-6">
										...
										<a class="col-md-12 text-primary mt-2"><small>Agregar un comentario</small></a>
									</div>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										<button type="submit" class="flex-c-m stext-101 cl2 size-100 bg8 bor13 hov-btn4 p-lr-15 trans-04 pointer m-tb-5">
											Eliminar
										</button>
									</div>
								</div>
							...
							<div class="flex-w flex-t bor12 p-t-15 p-b-30">
								...
								<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
									<p class="stext-111 cl6 p-t-2">
										Indicanos la direccion del evento
									</p>
									...
									<div class="p-t-15">
										...
										<div class="bor8 bg0 m-b-12">
											<textarea class="stext-111 cl8 plh3 size-111 p-lr-15" name="direccion" maxlength="100" id="" cols="30" rows="10">
