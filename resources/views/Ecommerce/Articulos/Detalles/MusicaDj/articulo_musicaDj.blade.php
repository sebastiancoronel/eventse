					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						...
						<div class="wrap-slick3 flex-sb flex-w ">
							...
							<div class="slick3 gallery-lb d-none d-sm-block">
								...
								<div class="item-slick3" data-thumb="{{$MusicaDj->foto_1}}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{$MusicaDj->foto_1}}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$MusicaDj->foto_1}}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="{{$MusicaDj->foto_2}}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{$MusicaDj->foto_2}}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$MusicaDj->foto_2}}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="{{$MusicaDj->foto_3}}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{$MusicaDj->foto_3}}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$MusicaDj->foto_3}}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="{{$MusicaDj->foto_4}}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{$MusicaDj->foto_4}}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$MusicaDj->foto_4}}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<p class="stext-102 cl3 p-t-23">
                            <i class="zmdi zmdi-pin"></i> {{$MusicaDj->localidad}}, {{$MusicaDj->provincia}}
						</p>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<form id="form_agregar_servicio" action="{{route('AgregarAlCarrito')}}" method="POST">
									@csrf
									<input id="id_musicaDj" hidden type="text" name="id_musicaDj" value="{{$MusicaDj->id}}">
							...
							<div class="row">
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<div class="p-b-30 m-lr-15-sm">
										@foreach ($OpinionesMusicaDj as $opinion_musicaDj)
										<!-- Review -->
											...
											<div class="size-207">
												<div class="flex-w flex-sb-m p-b-17">
													<span class="mtext-107 cl2 p-r-20">
														{{$opinion_musicaDj->name}} {{$opinion_musicaDj->lastname}}
													</span>
						...
						<div class="tab-pane fade how-pos2 p-lr-15-md" id="preguntas" role="tabpanel">
							...
							<div class="md-form">
								...
								<div id="mostrar_preguntas" >
									@foreach ($PreguntasMusicaDj as $pregunta_musicaDj)
									<div class="row mt-4 rounded">
										<span class="col-md-12 col-12 text-dark"> <i class="zmdi zmdi-comment-text"></i> {{$pregunta_musicaDj->pregunta}} </span><br>
										@if ( $pregunta_musicaDj->respuesta != null)
											<span class="col-md-12 col-12 mt-3 text-black-50" ><i class="zmdi zmdi-comment-alt-text"></i> {{$pregunta_musicaDj->respuesta}} </span><br><br><br>
										@endif
									</div>
									<hr>
									@endforeach
...
<script>
	...
	$("#form_agregar_servicio").submit(function(e){
		...
		var id_musicaDj = $('#id_musicaDj').val();
		var id_cliente = $('#id_cliente').val();

		$.ajax({
			method: 'POST',
			url: '{{url('/mi-paquete/agregando-musicaDj')}}',
			data: {
				id_musicaDj,
				id_cliente,
				_token: '{{csrf_token()}}'
...
<script>
	$('#form_pregunta').submit( function(e){
		...
		$.ajax({
			...
			method: 'POST',
			url: '{{url('/reservar/servicios-publicados/MusicaDj/almacenando-pregunta')}}',
			data: {
				id_prestador,
				id_musicaDj,
				id_cliente,
