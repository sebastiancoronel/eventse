      ...
      <div class="">
        <div class="card-header">
          ...
          <form class="card-body">
            ...
            <select class="custom-select mt-3" name="categoria_inmueble">
          ...
          <div class="d-flex justify-content-end">
            <div class="col-md-3 flex-c-m stext-101 cl2 size-100 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5 mt-5">
              Publicar
            </div>
          </div>
        </div>
